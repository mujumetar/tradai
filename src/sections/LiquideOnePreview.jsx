...
const LiquideOnePreview = () => {
    ...
    return (
        <section className="py-24 px-6 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto bg-secondary rounded-[48px] border border-white/10 p-8 md:p-16">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="bg-black/40 backdrop-blur-xl p-8 rounded-[32px] border border-white/10">
